  ...
  <main class="container my-4">
    ...
    <section class="panel mt-3">
      <div class="d-flex align-items-center gap-3">
        <img src="assets/img/logo-eduforo.svg" alt="Logo" style="width:60px;height:auto;">
        <div>
          <h1 class="h4 mb-1 page-title">Colegio Técnico San José</h1>
          <p class="small text-muted-90 mb-0">San José — Goicoechea — Técnico</p>
          <p class="small mb-0">Tel: 2222-2222 — Email: info@ctsj.ed.cr — Sitio: <a href="#">www.ctsj.ed.cr</a></p>
        </div>
      </div>
